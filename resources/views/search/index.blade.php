	...
	<div class="panel panel-default">
		...
		<div id="words" class="panel-body">
			...
			<div class="input-group showbtn-xs">
				<input id="searchbar" class="form-control" autocorrect="off" autocapitalize="none" autocomplete="off" placeholder="Search" />
				...
				$.ajax({
					...
					success: function(words) {
						if (words.length > 0)
						{
							...
							{
								var edit_link = "/meaning/" + words[i]['meaning_id'] + "/edit";
